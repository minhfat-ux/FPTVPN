...
export const chat: Dict = {
  ...
  "chat.template.title": "Template library",
  "chat.template.description": "Upload your Word/Excel/PPT templates so fBuddy can reuse them for you.",
  "chat.template.upload": "Upload template",
  "chat.template.uploading": "Uploading…",
  "chat.template.namePlaceholder": "Template name (optional)",
  "chat.template.hint": "For .xlsx fBuddy fills your actual template (formulas, formatting and logos are kept). For .docx/.pptx it follows the template structure and section order.",
  "chat.template.empty": "No templates yet — upload your first one.",
  "chat.template.selected": "In use",
  "chat.template.shared": "shared",
  "chat.template.delete": "Delete template",
  "chat.template.clear": "No template",
  "chat.template.wrongType": "Only .docx, .xlsx or .pptx",
  "chat.template.uploaded": "Template “{name}” added",
  "chat.template.uploadFailed": "Could not upload the template",
  "chat.template.loadFailed": "Could not load templates",
  "chat.template.deleted": "Template “{name}” deleted",
  "chat.template.deleteFailed": "Could not delete the template",
  "chat.template.chipOn": "Template: {name}",
  "chat.template.chipOff": "Choose template",
  "chat.template.pickTitle": "Pick a template for this turn",
};
