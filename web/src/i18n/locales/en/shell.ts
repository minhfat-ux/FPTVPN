...
export const shell: Dict = {
  ...
  // ---- Windows build (MeetFlow AI desktop app; provider keys live on the server)
  "shell.sidebar.desktop": "Windows app",
  "shell.view.desktop.title": "Windows app",
  "shell.view.desktop.subtitle": "Activation code for the MeetFlow AI Windows app, plus device management",
  "shell.desktop.loading": "Loading…",
  "shell.desktop.loadFailed": "Could not load the Windows app status",
  "shell.desktop.heroTitle": "MeetFlow AI for Windows",
  "shell.desktop.heroSub": "Real-time bilingual subtitles for your meetings — no Soniox/OpenRouter key inside the app.",
  "shell.desktop.download": "Download",
  "shell.desktop.step1": "Download and unzip the Windows package",
  "shell.desktop.step2": "Open MeetFlowAI.Win.exe",
  "shell.desktop.step3": "Paste the activation code into the Activate tab",
  "shell.desktop.retry": "Retry",
  "shell.desktop.notConfigured": "The Windows backend is not enabled yet. Contact us to enable it.",
  "shell.desktop.backendDown": "The Windows backend is not responding. Try again in a few minutes.",
  "shell.desktop.notEntitled": "No paid order on this account yet",
  "shell.desktop.notEntitledHint": "The Windows build unlocks with any confirmed top-up order — buy any package and it works.",
  "shell.desktop.goTopup": "Top up",
  "shell.desktop.codeSection": "Activation code",
  "shell.desktop.codeSectionHint": "We email a code whenever an order is confirmed. Getting a new code invalidates the previous one.",
  "shell.desktop.getCode": "Get activation code",
  "shell.desktop.getCodeAgain": "Get another code",
  "shell.desktop.codeLabel": "Activation code",
  "shell.desktop.codeExpiry": "Valid until {date}",
  "shell.desktop.codeEmailed": "New code emailed",
  "shell.desktop.codeShown": "New code created (email failed — use the code shown)",
  "shell.desktop.codeFailed": "Could not get an activation code",
  "shell.desktop.paidOrder": "From order {name}",
  "shell.desktop.devices": "Activated devices",
  "shell.desktop.noDevices": "No devices yet",
  "shell.desktop.noDevicesHint": "Once you activate inside the app, the machine shows up here so you can revoke it.",
  "shell.desktop.unknownDevice": "Unnamed device",
  "shell.desktop.lastSeen": "Last seen: {when}",
  "shell.desktop.revoke": "Revoke",
  "shell.desktop.revoked": "Device revoked",
  "shell.desktop.revokeFailed": "Could not revoke the device",
  "shell.desktop.devicesHint": "Revocation is permanent: that machine needs a new code to come back.",
