...
export const shell: Dict = {
  ...
  // ---- bản Windows (app MeetFlow AI trên Windows; key nhà cung cấp nằm ở server)
  "shell.sidebar.desktop": "Bản Windows",
  "shell.view.desktop.title": "Bản Windows",
  "shell.view.desktop.subtitle": "Mã kích hoạt cho app MeetFlow AI trên Windows và quản lý thiết bị",
  "shell.desktop.loading": "Đang tải…",
  "shell.desktop.loadFailed": "Không tải được trạng thái bản Windows",
  "shell.desktop.heroTitle": "MeetFlow AI cho Windows",
  "shell.desktop.heroSub": "Phụ đề song ngữ thời gian thực khi họp — không cần nhập key Soniox/OpenRouter trong app.",
  "shell.desktop.download": "Tải app",
  "shell.desktop.step1": "Tải và giải nén gói cho Windows",
  "shell.desktop.step2": "Mở MeetFlowAI.Win.exe",
  "shell.desktop.step3": "Dán mã kích hoạt vào tab Kích hoạt",
  "shell.desktop.retry": "Thử lại",
  "shell.desktop.notConfigured": "Chưa bật backend cho bản Windows. Liên hệ để được bật.",
  "shell.desktop.backendDown": "Backend bản Windows đang không phản hồi. Thử lại sau ít phút.",
  "shell.desktop.notEntitled": "Tài khoản chưa có đơn đã thanh toán",
  "shell.desktop.notEntitledHint": "Bản Windows mở khoá theo đơn nạp token đã xác nhận — nạp một gói bất kỳ là dùng được.",
  "shell.desktop.goTopup": "Nạp token",
  "shell.desktop.codeSection": "Mã kích hoạt",
  "shell.desktop.codeSectionHint": "Mã được gửi tới email của bạn mỗi khi đơn được xác nhận. Lấy mã mới thì mã cũ hết hiệu lực.",
  "shell.desktop.getCode": "Lấy mã kích hoạt",
  "shell.desktop.getCodeAgain": "Lấy mã khác",
  "shell.desktop.codeLabel": "Mã kích hoạt",
  "shell.desktop.codeExpiry": "Hết hiệu lực {date}",
  "shell.desktop.codeEmailed": "Đã gửi mã mới vào email",
  "shell.desktop.codeShown": "Đã tạo mã mới (email chưa gửi được — dùng mã hiển thị)",
  "shell.desktop.codeFailed": "Chưa lấy được mã kích hoạt",
  "shell.desktop.paidOrder": "Theo đơn {name}",
  "shell.desktop.devices": "Thiết bị đã kích hoạt",
  "shell.desktop.noDevices": "Chưa có thiết bị nào",
  "shell.desktop.noDevicesHint": "Sau khi kích hoạt trong app, máy sẽ hiện ở đây để bạn thu hồi khi cần.",
  "shell.desktop.unknownDevice": "Không rõ tên máy",
  "shell.desktop.lastSeen": "Hoạt động gần nhất: {when}",
  "shell.desktop.revoke": "Thu hồi",
  "shell.desktop.revoked": "Đã thu hồi thiết bị",
  "shell.desktop.revokeFailed": "Không thu hồi được thiết bị",
  "shell.desktop.devicesHint": "Thu hồi là dứt điểm: máy đó phải xin mã mới mới dùng lại được.",
