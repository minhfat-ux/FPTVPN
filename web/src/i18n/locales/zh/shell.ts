...
export const shell: Dict = {
  ...
  // ---- Windows 版（MeetFlow AI 桌面应用；服务商密钥保存在服务器）
  "shell.sidebar.desktop": "Windows 版",
  "shell.view.desktop.title": "Windows 版",
  "shell.view.desktop.subtitle": "MeetFlow AI Windows 应用的激活码与设备管理",
  "shell.desktop.loading": "加载中…",
  "shell.desktop.loadFailed": "无法加载 Windows 版状态",
  "shell.desktop.heroTitle": "MeetFlow AI Windows 版",
  "shell.desktop.heroSub": "会议实时双语字幕 —— 应用内无需填写 Soniox/OpenRouter 密钥。",
  "shell.desktop.download": "下载应用",
  "shell.desktop.step1": "下载并解压 Windows 安装包",
  "shell.desktop.step2": "打开 MeetFlowAI.Win.exe",
  "shell.desktop.step3": "在“激活”标签页粘贴激活码",
  "shell.desktop.retry": "重试",
  "shell.desktop.notConfigured": "Windows 版后端尚未启用，请联系我们开通。",
  "shell.desktop.backendDown": "Windows 版后端暂时无响应，请稍后再试。",
  "shell.desktop.notEntitled": "该账号还没有已支付的订单",
  "shell.desktop.notEntitledHint": "任意一笔已确认的充值订单即可解锁 Windows 版。",
  "shell.desktop.goTopup": "充值",
  "shell.desktop.codeSection": "激活码",
  "shell.desktop.codeSectionHint": "订单确认后我们会把激活码发到你的邮箱。获取新激活码后，旧码立即失效。",
  "shell.desktop.getCode": "获取激活码",
  "shell.desktop.getCodeAgain": "再获取一个",
  "shell.desktop.codeLabel": "激活码",
  "shell.desktop.codeExpiry": "有效期至 {date}",
  "shell.desktop.codeEmailed": "新激活码已发送到邮箱",
  "shell.desktop.codeShown": "已生成新激活码（邮件未发出 —— 请使用下方激活码）",
  "shell.desktop.codeFailed": "未能获取激活码",
  "shell.desktop.paidOrder": "来自订单 {name}",
  "shell.desktop.devices": "已激活的设备",
  "shell.desktop.noDevices": "还没有设备",
  "shell.desktop.noDevicesHint": "在应用内激活后，设备会显示在这里，方便你随时回收。",
  "shell.desktop.unknownDevice": "未命名设备",
  "shell.desktop.lastSeen": "最近活动：{when}",
  "shell.desktop.revoke": "回收",
  "shell.desktop.revoked": "已回收该设备",
  "shell.desktop.revokeFailed": "未能回收设备",
  "shell.desktop.devicesHint": "回收是彻底的：该设备需要新的激活码才能再次使用。",
