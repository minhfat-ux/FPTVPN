...
const IOS_TEXTS = {
  vi: {
    ...
    tfBoxText: 'Cài app TestFlight của Apple (miễn phí) rồi bấm nút cài app qua TestFlight — không cần UDID.',
  ...
  en: {
    ...
    tfBoxText: "Install Apple's free TestFlight app, then tap the install button — no UDID needed.",
  ...
  zh: {
    ...
    tfBoxText: '先安装 Apple 免费的 TestFlight，再点通过 TestFlight 安装 —— 不需要设备码。',
  ...
  ja: {
    ...
    tfBoxText: 'Apple の無料 TestFlight を入れてインストールボタンをタップ —— UDID 不要です。',
  ...
  ko: {
    ...
    tfBoxText: 'Apple의 무료 TestFlight를 설치한 뒤 설치 버튼을 누르세요 — UDID 불필요.',
...
const IOS_TF_TEXTS = {
  vi: {
    ...
    steps: [
      ...
      "<b>2.</b> Bấm nút <b>Cài VPNFlow qua TestFlight</b> ở dưới, bằng <b>Safari</b> trên chính iPhone cần cài (TestFlight sẽ tự mở).",
    ...
    joinBtn: "📲 Cài VPNFlow qua TestFlight",
  ...
  en: {
    ...
    steps: [
      ...
      "<b>2.</b> Tap <b>Install VPNFlow via TestFlight</b> below, in <b>Safari</b> on the iPhone you want to install on (TestFlight opens by itself).",
    ...
    joinBtn: "📲 Install VPNFlow via TestFlight",
  ...
  ja: {
    ...
    steps: [
      ...
      "<b>2.</b> インストールしたい iPhone の <b>Safari</b> で下の <b>TestFlight で VPNFlow をインストール</b> をタップ（TestFlight が自動で開きます）。",
    ...
    joinBtn: "📲 TestFlight で VPNFlow をインストール",
    notesTitle: "ご注意",
    notes: [
  ...
  ko: {
    ...
    steps: [
      ...
      "<b>2.</b> 설치할 iPhone의 <b>Safari</b>에서 아래 <b>TestFlight로 VPNFlow 설치</b>를 누릅니다 (TestFlight가 자동으로 열립니다).",
    ...
    joinBtn: "📲 TestFlight로 VPNFlow 설치",
    notesTitle: "알아두세요",
    notes: [
