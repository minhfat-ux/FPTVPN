...
export function buildSkillSuggestionBlock({ message = "", userId = null, lang = "vi" } = {}) {
  ...
  const lines = [
    ...
    "CÁCH DÙNG KHỐI NÀY:",
    "• Vẫn trả lời trọn vẹn điều người dùng hỏi TRƯỚC. Sau đó, nếu thật sự hợp, thêm MỘT câu gợi ý ngắn:",
    "  tên mục + mục đó giúp được gì + cách bật (\"bạn vào Chợ kỹ năng chọn … rồi bấm dùng\").",
