...
Chạy trên node-2:
  ...
  send-ios-b19-announcement.py                     # gửi cho khách có thiết bị iOS + gói còn hạn
  send-ios-b19-announcement.py --email a@b.com     # gửi 1 địa chỉ
  send-ios-b19-announcement.py --recipients        # chỉ LIỆT KÊ người nhận
